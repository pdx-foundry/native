use super::{TargetRecord, recipes::M45_OBSERVE};

// M45-observe, macOS ARM64. The identities come from the typed-extraction bundle
// 70fce0ce8dae5dbb… (reference-observation-prototype/evidence/initial-pin.json).
