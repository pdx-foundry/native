...
| `scopes`, `scope_links` | Implemented | — | Scope types with the keywords that the engine maps to each; documented links with declared input and output scopes, and the link prefixes that take data |
