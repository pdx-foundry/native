...
| sdk-515-loader-entry | Fresh Native debugger-worker candidate: two four-control batches, executed source/tool identities, private traces and independent disposal records; see [result](loader-entry-worker.md) |
